...
enum class ServiceTier { UNSPECIFIED, STANDARD, FLEX, PRIORITY };
...
enum class ToolType { TOOL_TYPE_UNSPECIFIED, GOOGLE_SEARCH_WEB, GOOGLE_SEARCH_IMAGE, URL_CONTEXT, GOOGLE_MAPS, FILE_SEARCH };
...
struct GroundingChunkStringList {
...
/** A predicted server-side `ToolCall` returned from the model. This message contains information about ... */
struct ToolCall {
    std::optional<std::string> id{};
...
/** The output from a server-side `ToolCall` execution. This message contains the results of a tool invo... */
struct ToolResponse {
    std::optional<std::string> id{};
    Required<ToolType> toolType;
    std::optional<jai::llm::json::Object> response{};
};
...
struct GoogleAiGenerativelanguageV1betaGroundingSupport {
    ...
    std::optional<std::vector<int64_t>> renderedParts{};
};

/** User provided metadata about the GroundingFact. */
struct GroundingChunkCustomMetadata {
    std::optional<std::string> stringValue{};
    std::optional<GroundingChunkStringList> stringListValue{};
...
struct RetrievedContext {
    ...
    std::optional<std::vector<GroundingChunkCustomMetadata>> customMetadata{};
};
...
struct ToolConfig {
    ...
    std::optional<bool> includeServerSideToolInvocations{};
};
...
struct Part {
    ...
    std::optional<ToolResponse> toolResponse{};
...
struct GenerateContentRequest {
    ...
    std::optional<ServiceTier> serviceTier{};
