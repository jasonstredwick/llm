...
struct ContentTypes {
    struct File {
        ...
        Required<std::string> file_data;
        Required<std::string> file_id;
        Required<EncodedUrl> file_url;
...
struct InputTypes {
    ...
    struct Item {
        ...
        struct OutputMessage {
            ...
            Required<ItemStatus> status;
            Required<KindOutputMessage> type{{}};
        };

        struct FileSearchToolCall {
            struct Result {
                using AttributeValue = std::variant<NameLen<512>, bool, double>;
                using AttributeMap = std::map<NameLen<64>, AttributeValue>;
        ...
        struct CompactionItem {
            ...
            Required<std::string> encrypted_content;
            Required<std::string> id;
            Required<std::string> created_by;
        };
        ...
        struct LocalShellCall {
            struct Action {
                ...
                Required<int64_t> timeout_ms;
                Required<std::string> user;
                Required<std::string> working_directory;
            };
        ...
        struct ShellToolCall {
            struct Action {
                ...
                Required<int64_t> max_output_length;
                Required<int64_t> timeout_ms;
            };
        ...
        struct MCPListTools {
            struct ToolDef {
                ...
                Required<std::string> name;
                Required<jai::llm::json::Object> annotations;
...
struct ItemReference {
    Required<KindItemReference> type{{}};
    Required<std::string> id;
};
...
struct ToolTypes {
    ...
    struct FileSearch {
        ...
        using Filter = std::variant<ComparisonFilter, CompoundFilter>;
        ...
        struct CompoundFilter {
            ...
            Required<std::vector<Filter>> filters;
        };
        ...
        Required<int64_t> max_num_results;
        Required<RankingOptions> ranking_options;
    };
    ...
    struct WebSearch {
        ...
        struct Location {
            ...
            Required<std::string> city;
            Required<std::string> country;
            Required<std::string> region;
            Required<std::string> timezone;
        };

        Required<WebSearchToolKind> type;
        Required<Filters> filters;
        Required<SearchContextSize> search_context_size;
        Required<Location> user_location;
    };

    struct MCP {
        struct Filter {
            Required<bool> read_only;
            std::optional<std::vector<std::string>> tool_names;
        };

        struct ApprovalFilter {
            Required<Filter> always;
            Required<Filter> never;
        };
        ...
        Required<std::string> server_label;
        Required<AllowedTools> allowed_tools;
        Required<std::string> authorization;
        Required<ConnectId> connector_id;
        std::optional<std::map<std::string, std::string>> headers;
        Required<RequiredApproval> require_approval;
        Required<std::string> server_description;
        Required<EncodedUrl> server_url;
    };
    ...
    struct CodeInterpreter {
        struct ContainerConfig {
            ...
            Required<std::string> memory_limit;
        };
    ...
    struct ImageGeneration {
        ...
        Required<std::string> action;
        Required<ImageGenerationBackground> background;
        Required<ImageGenerationFidelity> input_fidelity;
        Required<Mask> input_image_mask;
        Required<std::string> model;
        Required<std::string> moderation;
        Required<int64_t> output_compression;
        Required<ImageGenerationFormat> output_format;
        Required<int64_t> partial_images;
        Required<ImageGenerationQuality> quality;
        Required<ImageGenerationSize> size;
    };
